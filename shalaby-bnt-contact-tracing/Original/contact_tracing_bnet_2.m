function contact_tracing_bnet_2(file, infected_person_1, infected_person_2, T_infection)
tic;
addpath(genpath(pwd));
fid = fopen(file);
...
save(strcat(file, '_', num2str(T_infection),'_' , num2str(infected_person_1), '_2.mat'), 'results_p');
toc
