function contact_tracing_bnet_5(file, infected_person_1,infected_person_2,infected_person_3,infected_person_4,infected_person_5, T_infection)
tic;
addpath(genpath(pwd));
fid = fopen(file);
...
save(strcat(file, '_', num2str(T_infection),'_' , num2str(infected_person_1), '_5.mat'), 'results_p');
toc
